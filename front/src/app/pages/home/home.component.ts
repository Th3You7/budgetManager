  ...
  template: `
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div
          class="bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md border border-gray-100 dark:border-gray-700 p-6 transition-all duration-150"
        >
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200">
              Total Budget
            </h3>
            <span class="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-full">
              <svg
        ...
        >
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="p-2 bg-red-100 dark:bg-red-900/30 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          <p class="text-3xl font-bold text-red-600 dark:text-red-400">$0.00</p>
          <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Total amount spent
          </p>
        </div>
        ...
        >
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="p-2 bg-green-100 dark:bg-green-900/30 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <!-- Empty state -->
          <div
            class="col-span-full flex flex-col items-center justify-center p-8 text-center border border-dashed border-gray-200 dark:border-gray-700 rounded-lg"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <a
              routerLink="/categories"
              class="px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition"
            >
              Add Category
            </a>
          </div>
